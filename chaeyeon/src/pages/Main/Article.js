      ...
      <div className="feed">
          ...
          <div className="id_round">
            <div className="id_box">
              <div className="id_box_img">
                <img className="id_img" src="./images/peple01.png" alt="내 프로필" />
              </div>
            ...
            <div className="more_details">
              <img src="./images/option.PNG" alt="더보기" />
            </div>
          </div>
        </div>
        <div class="feed_picture">
          <img src=".//images/candy2.jpeg" alt="피드 사진" />
        </div>
        {/* <!--feedbottom--> */}
          ...
          <div className="emoticon_box">
            <div className="emoticon_box2">
              <div className="heart_box">
                <img className="heart" src="./images/like_good.png" alt="하트" />
              </div>
              <div className="comment_box">
                <img className="coment" src="./images/comment.PNG" alt="코멘트" />
              </div>
              <div className="direct_box">
                <img className="direct" src="./images/공유.png" alt="공유" />
              </div>
            </div>
            <div className="bookmark_box">
              <img className="bookmark" src="./images/save.PNG" alt="저장" />
            </div>
          </div>
        </div>
        {/* <!--/feedbottom--> */}
        <div className="feed_like_box">
          <div className="feed_like_picture">
            <img className="feed_like_peolpe" src="./images/peple01.png" alt="캔디" />
          </div>
